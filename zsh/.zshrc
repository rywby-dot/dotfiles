...
#  PYTHONWARNINGS='ignore' ponysay -o
#fi
...
bindkey -v
export PATH=/home/rywby/.local/bin:$PATH
compdef '_files -W ~/.config' vi
compdef '_files -W ~/.config' cmdc
...
alias mnd='mkdir -p '
# alias nir='nvim ~/.config/niri/config.kdl'
...
alias swao='dbus-run-session sway'
...
alias zsvi="nvim ~/.zshrc"
alias zpvi="nvim ~/.zprofile"
